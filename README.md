我是胡传鹏，2017年博士毕业于清华大学心理学系(现[心理与认知科学系](https://www.pcs.tsinghua.edu.cn/))，自2020年12月起在[南京师范大学心理学院](http://xlxy.njnu.edu.cn/)任教。I am Dr. Hu Chuan-Peng, a faculty member of the [School of Psychology](http://schools.njnu.edu.cn/psy/), [Nanjing Normal University](http://en.njnu.edu.cn/). 

## Research
I am interested in how humans make speeded decisions, especially when these decisions involves **self-related information**. I followed recommended practices to counter the "[credibility crisis](https://doi.org/10.1177/09637214211067779)" in psychology, and adopted a non-conventional approach in my team: we re-examine effects via meta-science, curate datasets for cumulating knowledge and (cognitive) modeling, and (re)assess (psychological) measurements to improve ontological commitment of constructs. 

I co-found [the Chinese Open Science Network](https://open-sci.cn/) (see our position paper in [AMPPS](https://journals.sagepub.com/doi/10.1177/25152459221144986) or [book chapter](https://osf.io/mw72e)). I have contributed to a series of Big-Team Science (BTS) and collected data in China. In the past five years, I also reflected on how researchers embrace open science practices in resource-constrained context (see our [guide for researchers in developing countries](https://journals.sagepub.com/doi/full/10.1177/25152459251357565)). Below are the resources we shared so far.
...
**[dockerHDDM](https://hub.docker.com/r/hcp4715/hddm)**: We created a docker image for [HDDM](https://hddm.readthedocs.io/en/latest/), a python package for hierarchical drift-diffusion models, please see our [tutorial paper](https://journals.sagepub.com/doi/full/10.1177/25152459251357565) on AMPPS. 
...
**2022 ~ currently**, **本科生的《高级心理统计学(贝叶斯统计)》**。该课程以《[*Bayes Rules!*](https://www.bayesrulesbook.com/)》为教材，2023/2024的课件均使用`Jupyter Notebook`完成，2025年以后转向使用R语言实现，以CC-BY方式开放，见[这里](https://github.com/hcp4715/psybayesian)，2025年/2024年的录屏上传至[B站](https://space.bilibili.com/252509184/channel/collectiondetail?sid=3799210)，录屏转录的[在线电子书](https://hcp4715.github.io/PyBayesianBook/)也公开获取。 | **Advanced Psychological Statistics (Bayesian statistics with Python)** for undergrads. This course focuses Bayesian statistics, I used [*Bayes Rules!*](https://www.bayesrulesbook.com/) as the textbook with both R and [`PyMC`](https://www.pymc.io/welcome.html) as the programming language.  All slide are prepared using `Jupyter Notebook` or `qmd` and are avialable [here](https://github.com/hcp4715/psybayesian). This course is in the autumn-winter semester.
...
**2021 ~ 2023**: (本科生的《心理统计学》). 所有的课件均使用`RMarkdown`做成，以CC-BY的方式开放，见[这里](https://github.com/hcp4715/PsyStats)。**Psychological Statistics** for undergrads. All slide are prepared using `RMarkdown` and are avialable [here](https://github.com/hcp4715/PsyStats). This course lasts for two semesters.
